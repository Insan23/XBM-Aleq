...
class Pengguna
{
    ...
    public function registerKelompok($Nama, $Alamat, $Email, $Email1, $Email2, $Email3, $Status, $NamaPemilik, $Nama1, $Nama2, $Nama3, $AlamatPemilik, $Alamat1, $Alamat2, $Alamat3, $TempatLahir, $TempatLahir1, $TempatLahir2, $TempatLahir3, $TanggalLahir, $TanggalLahir1, $TanggalLahir2, $TanggalLahir3, $Password, $Password1, $Password2, $Password3, $Tipe)
    {
        ...
        $db->exec("INSERT INTO pengguna(IDPengguna, NamaPengguna, KataSandi, Tingkatan, IDUsaha) VALUES ( '', '$Email1', '$Password1', 'Pengelola Transaksi', '$idUsaha');");
        $idPengguna = $db->lastInsertId();
        $result = $db->exec("INSERT INTO profil_pegawai(IDPegawai, Nama, Alamat, TempatLahir, TanggalLahir, IDPengguna, Status) VALUES ( '', '$Nama1', '$Alamat1', '$TempatLahir1', '$TanggalLahir1', '$idPengguna', 'Bekerja');");


        $db->exec("INSERT INTO pengguna(IDPengguna, NamaPengguna, KataSandi, Tingkatan, IDUsaha) VALUES ( '', '$Email2', '$Password2', 'Pengelola Gudang', '$idUsaha');");
        $idPengguna = $db->lastInsertId();
        $result = $db->exec("INSERT INTO profil_pegawai(IDPegawai, Nama, Alamat, TempatLahir, TanggalLahir, IDPengguna, Status) VALUES ( '', '$Nama2', '$Alamat2', '$TempatLahir2', '$TanggalLahir2', '$idPengguna', 'Bekerja');");


        $db->exec("INSERT INTO pengguna(IDPengguna, NamaPengguna, KataSandi, Tingkatan, IDUsaha) VALUES ( '', '$Email3', '$Password', 'Pengelola Keuangan', '$idUsaha');");
        $idPengguna = $db->lastInsertId();
        $result = $db->exec("INSERT INTO profil_pegawai(IDPegawai, Nama, Alamat, TempatLahir, TanggalLahir, IDPengguna, Status) VALUES ( '', '$Nama3', '$Alamat3', '$TempatLahir3', '$TanggalLahir3', '$idPengguna', 'Bekerja');");
        if ($result > 0) {
            return true;
        } else {
            return false;
